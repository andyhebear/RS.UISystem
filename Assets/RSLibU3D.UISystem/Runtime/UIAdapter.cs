...
namespace RS.Unity3DLib.UISystem
{
    ...
    public class UIRootAdapter : MonoBehaviour
    {
        ...
        [SerializeField] private Color _backSideColor = Color.red;
        ...
        private void UpdateBlackBarsDelayed() {
            ...
            if (backgroundMask != null) {
                ...
                bc.transform.SetAsFirstSibling();
        ...
        /// 动态切换适配模式（外部调用接口）
        /// </summary>
        public void SwitchAdaptMode(AdaptMode newMode,Camera uiCamera = null) {
            _adaptMode = newMode;
            if (uiCamera != null) {
                _uiCamera = uiCamera;
    ...
    /// <summary>
    /// 黑边管理器（仅在BlackBars模式下生效，挂载在BackgroundLayer节点）
    /// </summary>
